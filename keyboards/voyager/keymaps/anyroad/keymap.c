...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [EXTRAS] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, HYPR(KC_T),                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, HYPR(KC_O), KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, ST_MACRO_SQL_SELECT, KC_TRANSPARENT, HYPR(KC_F), HYPR(KC_G),                            HYPR(KC_H), HYPR(KC_J), HYPR(KC_K), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
